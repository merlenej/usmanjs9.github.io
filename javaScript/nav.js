...
<link href="https://fonts.googleapis.com/css?family=Bowlby+One+SC|Monoton" rel="stylesheet">
</head>
<script>
  var nav="bread-crumb-items";
  var text;
  var i;
for("i = 0; i>=nav.length; i++;"){
   text+= nav(i);
}
document.getElementsByTagName('bread-crumb').innerHTML =
 "text";
</script>
